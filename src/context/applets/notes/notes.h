 ...
 */
class BASKET_EXPORT NotesTextEdit : public KRichTextEdit {
    Q_OBJECT
 ...
 * @author Björn Ruberg <bjoern@ruberg-wegener.de>
 */
class BASKET_EXPORT PlasmaTextEdit : public Plasma::TextEdit {
    Q_OBJECT
...
class BASKET_EXPORT Notes : public Applet
{
    Q_OBJECT
...
//K_EXPORT_BASKET_APPLET(notes, Notes)
